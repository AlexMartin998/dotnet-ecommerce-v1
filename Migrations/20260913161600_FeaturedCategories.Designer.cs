...
namespace ApiEcommerce.Migrations
{
    ...
    [Migration("20260913161600_FeaturedCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Accounts.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Categories", t =>
                        {
                            t.HasCheckConstraint("CK_Categories_FeaturedPosition", "[FeaturedPosition] BETWEEN 1 AND 3");
                        });
                });

            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Ordering.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReceiptDocumentKey")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("BuyerUserId", "PlacedAt")
                        .HasDatabaseName("IX_Orders_Buyer_PlacedAt");

                    b.ToTable("Orders");
                });

            modelBuilder.Entity("ApiEcommerce.Features.Ordering.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiEcommerce.Shared.Messaging.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Sequence"), new[] { "Attempts" });

                    b.ToTable("OutboxMessages");
                });

            modelBuilder.Entity("ApiEcommerce.Shared.Messaging.ProcessedMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.Product", b =>
                {
                    b.HasOne("ApiEcommerce.Features.Catalog.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Catalog.Models.ProductImage", b =>
                {
                    b.HasOne("ApiEcommerce.Features.Catalog.Models.Product", "Product")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("ApiEcommerce.Features.Ordering.Models.OrderItem", b =>
                {
                    b.HasOne("ApiEcommerce.Features.Ordering.Models.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiEcommerce.Features.Catalog.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiEcommerce.Features.Catalog.Models.ProductVariant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiEcommerce.Features.Accounts.Models.ApplicationUser", null)
                        .WithMany()
